      ...
      <main className="flex-1 container px-4 py-16 max-w-3xl">
        ...
        <div className="prose prose-lg dark:prose-invert space-y-6">
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              You agree not to misuse our website or services. This includes but is not 
              limited to: attempting to gain unauthorized access, submitting false 
              information, or using automated means to submit multiple registrations.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              the waitlist after changes constitutes acceptance of the new terms.
            </p>
          </section>
